...
setup(
    ...
    author="Thang Duong Dinh, Thi Hoang Ngoc Ba, Tan Trinh Nhat",
    author_email="19522195@gm.uit.edu.vn",
    url="https://github.com/ThangDuong59/CS106-Vietnam-Stock-Trading.git",
    license="MIT",
    packages=find_packages(),
    #install_requires=REQUIRES,
    install_requires=REQUIRES
    + ["pyfolio @ git+https://github.com/quantopian/pyfolio.git#egg=pyfolio-0.9.2", "vnquant @ git+https://github.com/phamdinhkhanh/vnquant.git#egg=vnquant"],
